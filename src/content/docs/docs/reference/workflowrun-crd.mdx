---
title: WorkflowRun schema
description: Every field on the plnt.work/v1 WorkflowRun CRD. Types, defaults, validation constraints.
---

The canonical schema for the `WorkflowRun` CRD. Source of truth: [`plnt/operators/crds/workflowrun.yaml`](https://github.com/plnt-work/plnt/blob/main/plnt/operators/crds/workflowrun.yaml).
