...
- Schema-validates the InferenceModel spec.
...
- Workflow: [`plnt/workflows/deploy_model.py`](https://github.com/devdattatalele/plnt/blob/main/plnt/workflows/deploy_model.py)
- Activities: [`plnt/workflows/activities.py`](https://github.com/devdattatalele/plnt/blob/main/plnt/workflows/activities.py)
- Worker: [`plnt/workflows/worker.py`](https://github.com/devdattatalele/plnt/blob/main/plnt/workflows/worker.py)
- Operator: [`plnt/operators/inferencemodel_controller.py`](https://github.com/devdattatalele/plnt/blob/main/plnt/operators/inferencemodel_controller.py)
