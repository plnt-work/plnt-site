...
Live in [`plnt/playground/backends.py`](https://github.com/devdattatalele/plnt/blob/main/plnt/playground/backends.py):
...
2. **CRD enum bump** — add `llama-cpp` to `spec.runtime`'s enum in [`plnt/operators/crds/inferencemodel.yaml`](https://github.com/devdattatalele/plnt/blob/main/plnt/operators/crds/inferencemodel.yaml).
