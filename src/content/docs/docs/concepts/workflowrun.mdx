...
See [WorkflowRun schema reference](/docs/reference/workflowrun-crd/) for every field with type, default, and validation constraints. The CRD YAML lives at [`plnt/operators/crds/workflowrun.yaml`](https://github.com/plnt-work/plnt/blob/main/plnt/operators/crds/workflowrun.yaml).
